...
(async function() {
  ...
  const imageBuffer = await bakeImage(imageUrl, false, 190*5, "R10000", "BEST SELLER", false, 0.65, "#FF7D00",  "#FFFFFF", true);

  fs.writeFileSync("./test/test-2cola.jpg", imageBuffer);
